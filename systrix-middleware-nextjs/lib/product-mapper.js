...
class ProductMapper {
  ...
  loadMapping() {
    ...
    // Default mappings if no environment variables are set
    if (Object.keys(mapping).length === 0) {
      mapping['1'] = '5';   // VPS Basic -> VPS Start
      mapping['2'] = '10';  // VPS Pro -> VPS Profi
      mapping['3'] = '11';  // VPS Premium -> VPS Premium
      mapping['4'] = '12';  // VPS Enterprise -> VPS Enterprise
      
      logger.info('Using default product mappings', { mapping });
    }
