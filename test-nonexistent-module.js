/**
 * Test Non-existent Module Value (ID 999) with as_free: 0
 */
...
async function testNonExistentModule() {
  console.log('🚀 Testing Non-existent Module (ID 999) with as_free: 0');
  console.log('================================================================================');

  try {
    // Create test order with non-existent module
    console.log('1️⃣ Creating test order with non-existent module (ID 999)...');
    
    const orderData = {
      customer: {
        firstName: "Test",
        lastName: "NonExistentModule",
      ...
      paymentMethod: "999", // Non-existent module ID
      total: 361.79
    };
    ...
    if (order.invoiceId && order.invoiceId !== '0') {
      ...
      console.log('🟢 RESULT: No invoice created (correct behavior for non-existent module)');
    }
