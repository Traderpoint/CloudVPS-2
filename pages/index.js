        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="group p-8 rounded-3xl shadow-lg bg-white hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-primary-200">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <Link
                href="/vps2"
                className="inline-flex items-center text-blue-600 font-semibold hover:text-blue-700 transition-colors bg-blue-50 px-3 py-1 rounded-lg"
              >
                VPS 2 - Dlaždicový pohled
                <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <Link
                href="/vps3"
                className="inline-flex items-center text-purple-600 font-semibold hover:text-purple-700 transition-colors bg-purple-50 px-3 py-1 rounded-lg"
              >
                VPS 3 - Quantum Design
                <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
