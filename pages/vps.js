    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 relative overflow-hidden">
      ...
      <div className="container mx-auto py-6 px-4 relative z-10">
        ...
        <div className="text-center mb-6">
          <h1 className="text-3xl font-bold mb-3 text-gray-900">Systrix VPS Hosting</h1>
          ...
          <div className="xl:w-2/3">
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden mb-4">
              <div className="bg-gradient-to-r from-primary-600 to-primary-700 text-white p-3">
                <h2 className="text-base font-bold">Vyberte si svou VPS</h2>
              </div>
            </div>
            <div className="space-y-3">
              {productsLoading ? (
                ...
                <div key={plan.id} className="bg-white rounded-xl shadow-lg border border-gray-100 p-4 relative overflow-hidden hover:shadow-xl transition-all duration-300">
                  {plan.popular && (
                    <div className="absolute top-0 right-0 bg-gradient-to-r from-orange-500 to-orange-600 text-white px-2 py-1 rounded-bl-lg text-xs font-bold shadow-lg">
                      Nejpopulárnější
                    </div>
                  )}
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    <div className="lg:w-1/3 mb-3 lg:mb-0">
                      ...
                      <div className="text-2xl font-bold text-primary-600 mb-1">{plan.price}</div>
                      <div className="text-xs text-gray-500">bez DPH / měsíc</div>
                    </div>

                    <div className="lg:w-1/3 mb-3 lg:mb-0">
                      <div className="grid grid-cols-1 gap-1">
                        <div className="flex items-center">
                          <svg className="w-3 h-3 text-primary-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                          </svg>
                          <span className="text-xs text-gray-700"><strong>CPU:</strong> {plan.cpu}</span>
                        </div>
                        <div className="flex items-center">
                          <svg className="w-3 h-3 text-primary-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                          </svg>
                          <span className="text-xs text-gray-700"><strong>RAM:</strong> {plan.ram}</span>
                        </div>
                        <div className="flex items-center">
                          <svg className="w-3 h-3 text-primary-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                          </svg>
                          <span className="text-xs text-gray-700"><strong>Storage:</strong> {plan.storage}{plan.storage.includes('SSD') ? '' : ' NVMe SSD'}</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="lg:w-1/3 lg:text-right">
                      ...
                      {plan.allPrices && (
                        <div className="mb-2 text-xs text-gray-600 space-y-1">
                          ...
                          {/* Show savings for selected periods */}
                          {(() => {
                      ...
                      <button
                        ...
                        className={`w-full lg:w-auto px-4 py-2 rounded-lg font-bold shadow-lg transition-all duration-300 transform hover:-translate-y-1 text-sm ${
                          affiliateValidated
                      ...
                      {affiliateValidated && (
                        <p className="text-xs text-gray-500 mt-1 text-center lg:text-right">
            ...
            <div className="mt-4 bg-white rounded-lg shadow-lg p-3">
              <h3 className="text-sm font-bold mb-2 text-gray-900">Klíčové výhody VPS</h3>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                {[
                  ...
                  <div key={index} className="text-center p-1.5 rounded-lg hover:bg-primary-50 transition-colors">
                    <div className="text-sm mb-0.5">{feature.icon}</div>
                    <h4 className="font-semibold text-gray-900 text-xs mb-0.5">{feature.title}</h4>
