...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Middleware returns modules as array, but Invoice Payment Test expects object
    const modulesObject = {};

    if (result.modules && Array.isArray(result.modules)) {
      result.modules.forEach((module) => {
        // Use hostbillModuleId as key, name as value
        modulesObject[module.hostbillModuleId || module.id] = module.name;
      });
    }
